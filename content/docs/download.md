...
* **[Download Installer (.exe)](https://github.com/JakeyTTS/JakeyTTS/releases/download/v2.0.2/JakeyTTS_v2.0.2.exe)**
...
The development branch will be published once the contributions are cleaned and only the JakeyTTS related code remains. Apologize for the inconvenience.